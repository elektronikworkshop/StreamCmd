 ...
 *
 */
template<size_t _NumCommandSets    =  1,
         size_t _MaxCommands       = 32,
         size_t _CommandBufferSize = 32,
...
protected:
  ...
  { /* This generates a warning with the AVR platform but the sloppy
     * AVR lib implementation doesn't make strtold available in the std
     * namespace which would be necessary to fix this issue.
     */
